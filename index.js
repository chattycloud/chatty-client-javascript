...
var Chatty = /** @class */ (function () {
    ...
    Chatty.generateDistinctKey = function (data) {
        if (!data || (Array.isArray(data) && data.length < 1)) {
            console.error(':: ChattyClient generateDistinctKey function param error: data is undefined');
            return;
        }
        var distinct = data;
     ...
     */
    Chatty.createSystemMessage = function (payload) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post('/chats', {
                            id: payload.ChatId,
                            distinctKey: payload.ChatDistinctKey,
                            Messages: [{ text: payload.text, json: payload.json, AppId: (_a = this.app) === null || _a === void 0 ? void 0 : _a.id, by: Types_1.MessageByEnum.SYSTEM }],
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get("/missed-count?MemberId=".concat((_a = this.member) === null || _a === void 0 ? void 0 : _a.id))
                            .then(function (res) { return Promise.resolve(res.data); })
                            .catch(function (err) { Promise.reject(err.response.data.response || err.response.data); })];
    ...
    Chatty.getMembersByGroup = function (group) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get("/members?AppId=".concat((_a = this.app) === null || _a === void 0 ? void 0 : _a.id, "&group=").concat(group))
                            .then(function (res) { return Promise.resolve(res.data); })
                            .catch(function (err) { return Promise.reject(err.response.data.response || err.response.data); })];
                    case 1: return [2 /*return*/, _b.sent()];
                }
...
function axiosHeaderConfig(ApiKey) {
    axios_1.default.defaults.baseURL =  true ? 'http://localhost:3300' : 0;
...
exports.ChattyTypes = __importStar(__webpack_require__(1));
...
axios.CanceledError = __webpack_require__(25);
...
axios.toFormData = __webpack_require__(16);

// Expose AxiosError class
axios.AxiosError = __webpack_require__(14);
...
var defaults = __webpack_require__(12);
var CanceledError = __webpack_require__(25);
...
var toFormData = __webpack_require__(16);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(27)
  },
...
var AxiosError = __webpack_require__(14);
var CanceledError = __webpack_require__(25);
var parseProtocol = __webpack_require__(26);
...
var socket_io_client_1 = __importDefault(__webpack_require__(36));
...
var ChattyChat = /** @class */ (function () {
    ...
    ChattyChat.prototype.connect = function (payload) {
        ...
        var url =  true ? 'ws://localhost:4400' : 0;
        // option checker
...
const url_js_1 = __webpack_require__(37);
const manager_js_1 = __webpack_require__(42);
Object.defineProperty(exports, "Manager", ({ enumerable: true, get: function () { return manager_js_1.Manager; } }));
const socket_js_1 = __webpack_require__(63);
Object.defineProperty(exports, "Socket", ({ enumerable: true, get: function () { return socket_js_1.Socket; } }));
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.url = void 0;
const parseuri_1 = __importDefault(__webpack_require__(38));
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
...
const engine_io_client_1 = __webpack_require__(43);
const socket_js_1 = __webpack_require__(63);
const parser = __importStar(__webpack_require__(64));
const on_js_1 = __webpack_require__(67);
const backo2_1 = __importDefault(__webpack_require__(68));
const component_emitter_1 = __webpack_require__(51);
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
...
const socket_js_1 = __webpack_require__(44);
Object.defineProperty(exports, "Socket", ({ enumerable: true, get: function () { return socket_js_1.Socket; } }));
exports.protocol = socket_js_1.Socket.protocol;
var transport_js_1 = __webpack_require__(53);
Object.defineProperty(exports, "Transport", ({ enumerable: true, get: function () { return transport_js_1.Transport; } }));
var index_js_1 = __webpack_require__(45);
Object.defineProperty(exports, "transports", ({ enumerable: true, get: function () { return index_js_1.transports; } }));
var util_js_1 = __webpack_require__(50);
...
const util_js_1 = __webpack_require__(50);
const parseqs_1 = __importDefault(__webpack_require__(60));
const parseuri_1 = __importDefault(__webpack_require__(38));
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
const component_emitter_1 = __webpack_require__(51);
const engine_io_parser_1 = __webpack_require__(54);
...
const polling_xhr_js_1 = __webpack_require__(46);
const websocket_js_1 = __webpack_require__(61);
exports.transports = {
...
const xmlhttprequest_js_1 = __importDefault(__webpack_require__(47));
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
const globalThis_js_1 = __importDefault(__webpack_require__(49));
const util_js_1 = __webpack_require__(50);
const component_emitter_1 = __webpack_require__(51);
const polling_js_1 = __webpack_require__(52);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const has_cors_1 = __importDefault(__webpack_require__(48));
const globalThis_js_1 = __importDefault(__webpack_require__(49));
...
const transport_js_1 = __webpack_require__(53);
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
const yeast_1 = __importDefault(__webpack_require__(59));
const parseqs_1 = __importDefault(__webpack_require__(60));
const engine_io_parser_1 = __webpack_require__(54);
...
const encodePacket_js_1 = __webpack_require__(55);
exports.encodePacket = encodePacket_js_1.default;
const decodePacket_js_1 = __webpack_require__(57);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const commons_js_1 = __webpack_require__(56);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const commons_js_1 = __webpack_require__(56);
const base64_arraybuffer_1 = __webpack_require__(58);
const withNativeArrayBuffer = typeof ArrayBuffer === "function";
...
const yeast_1 = __importDefault(__webpack_require__(59));
const util_js_1 = __webpack_require__(50);
const websocket_constructor_js_1 = __webpack_require__(62);
const debug_1 = __importDefault(__webpack_require__(39)); // debug()
const engine_io_parser_1 = __webpack_require__(54);
...
const debug_1 = __webpack_require__(39); // debug()
...
var ChattyList = /** @class */ (function () {
    ...
    ChattyList.prototype.addListener = function () {
        ...
        this.socket.on(Types_1.ChattyEvent.UPDATE_CHATLIST_DONE, function (data) {
            console.debug(":: ChattyList UPDATE_CHATLIST_DONE", data);
